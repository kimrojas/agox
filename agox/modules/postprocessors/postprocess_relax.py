...
class PostprocessRelax(PostprocessBaseClass):

    name = 'PostprocessRelaxNew'

    """
    New relaxation module - Goals:

    1. Handles confinemenet in a better way than currently so that it can be unconfined in some directions. 
    2. Handles PBC - This is in relation to 1. so that e.g. a surface relaxation can be confined in one dimension and 
        periodic in others. 
    3. Does not use a custom optimizer.
    """
