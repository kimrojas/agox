    ...
    def train(self, atoms_list=None, data_values=None, features=None, delta_values=None, add_new_data=True, optimize=None, comm=None):
        ...
        **GSkwargs:
        ...
        if features is None:
            ...
            if self.verbose:
                print('Feature time: %4.4f' %(time.time()-t))
        ...
        if optimize and self.kernel_.n_dims > 0:
            if self.verbose:
                print('Optimizing log-likelihood - {}'.format(self.n_restarts_optimizer))
        ...
        try:
            ...
            if self.verbose:
                print('Inversion time: %4.4f' %(time.time()-t))
        ...
        if self.verbose:
            print('GPR model k1:',self.kernel_.get_params().get('k1','NA'))
            print('GPR model k2:',self.kernel_.get_params().get('k2','NA'))
