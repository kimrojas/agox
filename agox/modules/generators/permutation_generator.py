...
class PermutationGenerator(GeneratorBaseClass):
    ...
    def __init__(self, acquisitor=None, max_number_of_swaps=1, rattle_strength=0., use_xy_only=False, ignore_H=False, verbose=False, **kwargs):
