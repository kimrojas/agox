...
class DualPointEvaluator(EvaluatorBaseClass):
    ...
    def __init__(self, calculator, rmax=0.1, fmax=5, fix_template=True, constraints=[], number_to_gauge=1, **kwargs):
        super().__init__(number_to_gauge=2*number_to_gauge, **kwargs)
