...
class GeneticSampler(SamplerBaseClass):
    ...
    def __init__(self, database=None, comparator=None, population_size=10, gets={'get_key':'evaluated_candidates'}, order=6, 
    ...
    def setup(self):        
        ...
        possible_candidates = self.get_recent_candidates()
