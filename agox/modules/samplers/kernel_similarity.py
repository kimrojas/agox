...
class KernelSimSampler(SamplerBaseClass):
    ...
    def __init__(self, feature_calculator, model_calculator, database=None, similarity_criterion=0.95, log_scale=False, sample_size=10, use_saved_features=False, **kwargs):
