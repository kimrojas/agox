...
from agox.modules.postprocessors import constraints
...
class EnvironmentBaseClass(ABC):
    ...
    def __init__(self, confinement_cell=None, confinement_corner=None, constraints=[], use_box_constraint=True):
