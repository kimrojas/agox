import numpy as np
from agox.modules.acquisitors.ABC_acquisitor import AcquisitorBaseClass, AcquisitonCalculatorBaseClass
...
class LowerConfidenceBoundAcquisitor(AcquisitorBaseClass):
    ...
    def get_acquisition_calculator(self, database):
        return LowerConfidenceBoundCalculator(database, self.model_calculator, self.acquisition_function, self.acquisition_force)
