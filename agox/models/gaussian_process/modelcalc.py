...
class ModelCalculator(Calculator):
    ...
    def __init__(self, model=None, kappa=0, iteration_start_training=7, train_N_best=500, train_filter=False, dE=5, update_interval=1, max_energy=20, 
                 test_set=None, iteration_stop_training=1E10, max_adapt_iters=5, n_adapt=25, **kwargs):
        self.results = {}
        self.model = model
        self.kappa = kappa
        ...
        self.iteration_stop_training = iteration_stop_training
    ...
    def get_uncertainty(self, atoms=None):
        return self.get_property(name='uncertainty', atoms=atoms)
    ...
    def update_V1(self):
        iteration_no = self.get_iteration_counter()
        if iteration_no < self.iteration_start_training or iteration_no % self.update_interval != 0:
            return
        
        if iteration_no > self.iteration_stop_training:
        ...
        # k1 = self.model.kernel_.get_params()['k1']
        # l1 = self.model.kernel_.get_params()['k2__k1__k1__k2__length_scale']
        # l2 = self.model.kernel_.get_params()['k2__k1__k2__k2__length_scale']
    ...
    def assign_from_ASLA(self, asla, main):
        ...
        self.get_iteration_counter = asla.get_iteration_counter
    ...
    #   _put_missing_atoms_at_infinity
    ...
    def get_simulated_energy(self, grid):
        grid = self._put_missing_atoms_at_infinity(grid)
        return self.model.predict_energy(grid)
